        ...
        <ul
          ...
          <li>
            ...
            <div id="dropdownNavbar"
              class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-emerald-800 dark:divide-emerald-800">
              <ul class="py-2 text-sm text-white dark:text-white" aria-labelledby="dropdownLargeButton">
                <li>
                  <a href="CommunityAndEvents.html"
                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-white md:dark:hover:text-emerald-800">COMMUNITY
                    AND EVENTS</a>
                </li>
                <li>
                  <a href="BlogNews.html"
                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-white md:dark:hover:text-emerald-800">BLOG /
                    NEWS</a>
                </li>
                <li>
                  <a href="Testimonials.html"
                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-white md:dark:hover:text-emerald-800">TESTIMONIALS</a>
                </li>
              </ul>
            </div>
          </li>
          <li>
            <a href="Sitemap.html"
              class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-emerald-800 md:p-0 md:dark:hover:text-emerald-800 md:dark:hover:bg-transparent">SITEMAP</a>
          </li>
          <li>
            <a href="Contact.html"
              class="rounded-md bg-emerald-800 px-3.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-white hover:text-emerald-800 hover:border focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-800">CONTACT</a>
          </li>
        </ul>
      </div>
    </div>

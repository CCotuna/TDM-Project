...
<template>
    <footer class="w-full">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                class=" py-14 grid grid-cols-1 lg:grid-cols-3 gap-y-8 max-w-sm mx-auto sm:max-w-lg md:max-w-3xl lg:max-w-full lg:gap-x-12">
                <div class="w-full lg:max-w-xs mb-10  lg:mb-0 col-span-full lg:col-span-1">
                    <a href="https://pagedone.io/" class="flex justify-center lg:justify-start mb-8">
                        SWEET LIKE HONEY
                    </a>
                    <p class="text-gray-500 mb-8 text-center lg:text-left">Trusted in more than 100 countries & 5
                        million customers. Get the app now</p>
                    <div class="flex items-center justify-center gap-4 space-x-5 text-xl lg:block">
                        <a href="javascript:;" class="text-gray-600 hover:text-gray-900"><i
                ...
                <div class=" flex items-start justify-between max-w-sm mx-auto w-full lg:max-w-xs lg:ml-0">
